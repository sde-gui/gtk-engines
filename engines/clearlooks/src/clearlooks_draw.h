...
void clearlooks_draw_progressbar_fill (cairo_t *cr,
                                       ...
                                       int x, int y, int width, int height, gint offset) G_GNUC_INTERNAL;
...
void clearlooks_draw_inset            (cairo_t *cr,
                                       ...
                                       double radius, uint8 corners) G_GNUC_INTERNAL;
...
void clearlooks_draw_scrollbar_stepper (cairo_t *cr,
                                        const ClearlooksColors           *colors,
                                        const WidgetParameters           *widget,
...
void clearlooks_draw_scrollbar_slider (cairo_t *cr,
                                       const ClearlooksColors          *colors,
                                       const WidgetParameters          *widget,
                                       const ScrollBarParameters       *scrollbar,
                                       int x, int y, int width, int height) G_GNUC_INTERNAL;
...
void clearlooks_draw_arrow            (cairo_t *cr,
                                       const ClearlooksColors          *colors,
                                       const WidgetParameters          *widget,
